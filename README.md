...
# Purpose: Verify heartbeat and registry alignment for clickdash.net

echo "📡 [GGC_DNA_INIT] Initiating Resonance Probe..."

# 1. Ping the MotherBot Registry
REGISTRY_STATUS=$(curl -s -o /dev/null -w "%{http_code}" https://clickdash.net-motherbot-v1.up.railway.app/health)
